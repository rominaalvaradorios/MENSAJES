...
def productos_view(page: ft.Page):
    ...
    titulo = ft.Text("Aplicación saludooooo!", style=Textos_estilos.H1)
    subtitulo = ft.Text("Sistema con estilos :D", style=Textos_estilos.H2)
    ...
    def on_click(e):
        mensaje_text.value = f"Holaaaaaaaa {nombre.value}"
        page.update()
